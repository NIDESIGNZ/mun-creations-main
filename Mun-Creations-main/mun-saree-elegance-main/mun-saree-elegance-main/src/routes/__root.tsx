  ...
  head: () => ({
    meta: [
      ...
      { title: "Mun Creations — Handwoven Indian Sarees" },
      {
        name: "description",
        content:
          "Authentic handcrafted Indian sarees, bridal couture and festive wear. Woven by master artisans. Ships worldwide.",
      },
      { name: "author", content: "Mun Creations" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#4a1220" },
    ],
    links: [
