...
export const CATEGORY_FILTERS = [
  "Ajrak", "Anarkali", "Banarasi", "Batik Silk", "Bengal Matka Silk", "Bengal Silk",
  "Blouse", "Chiffon", "Chikankari", "Co-Ord Set", "Cotton", "Cotton Ikkat",
  "Crepe", "Crepe Satin", "Crush Tissue", "Crushed Tissue", "Gadwal", "Georgette",
  "Gujarati", "Jamdani", "Kani", "Khaddi Banarasi", "Kanjivaram", "Linen",
  "Mangalgiri", "Mashru", "Organza", "Pochampally", "Resham Check", "Satin Zardosi",
  "Semi Khaddi", "Semi Mashru", "Silk", "Tissue", "Tussar", "Zardosi",
];

export const FABRIC_FILTERS = [
  "Silk", "Cotton", "Linen", "Satin", "Viscose", "Polyester",
  "Synthetic", "Modal", "Mesh", "Nylon", "Other",
];
